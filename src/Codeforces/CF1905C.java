...
public final class CF1905C {
    ...
    public static void main(String[] args) {
        ...
        while (test-- > 0) {
            ...
            char sorted[] = ch.clone();
            Arrays.sort(sorted);
            if(Arrays.equals(sorted, ch)){
                out.println(0);
                continue;
            }
            ...
            for(int i=0;i<n;i++){
                ...
                while(!stack.isEmpty() && stack.getLast().first < ch[i]){
                    stack.removeLast();
                    que.removeLast();
                }
                stack.add(new Pair(ch[i], i));
            ...
            while(i<n){
                ...
                if(!stack.isEmpty() &&  i == que.getFirst()){
                    ch[i] = stack.removeLast().first;
                    que.removeFirst();
                    count++;
                }
                i++;
