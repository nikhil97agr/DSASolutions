...
public final class CF1927C {
    ...
    public static void main(String[] args) {
        ...
        while (test-- > 0) {
            ...
            for(int x : a){
                if(!selected.contains(x) && !b.contains(x) && x<=k){
                    c1++;
                    selected.add(x);
                }
                if(c1 == (k/2)) break;
            ...
            for(int y : b){
                if(!selected.contains(y) && !a.contains(y) && y <=k ){
                    c2++;
                    selected.add(y);
                }
                if(c2 == (k/2)) break;
