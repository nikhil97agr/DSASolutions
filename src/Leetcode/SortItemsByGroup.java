...
public class SortItemsByGroup {
    ...
    private List<Integer> topoSort(Collection<Integer> nodes, Map<Integer, List<Integer>> graph,
            Map<Integer, Integer> inDegree) {
        Queue<Integer> queue = new LinkedList<>(
                nodes.stream().filter(node -> !inDegree.containsKey(node)).collect(Collectors.toList()));
